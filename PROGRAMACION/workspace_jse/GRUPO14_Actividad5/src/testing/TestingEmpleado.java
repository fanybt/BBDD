...
public class TestingEmpleado {
	...
	public static void main(String[] args) {
		...
		System.out.println(empleado1.nombreCompleto()+ " " + empleado1.literalSexo() + " " + empleado1.getDepartamento().getDescripcion() + " " + empleado1.getTrabajo().getDescripcion() + " " + empleado1.getDepartamento().getLocalidad().getDireccion() + " " + empleado1.getDepartamento().getLocalidad().getCiudad() + " " + empleado1.getDepartamento().getLocalidad().getPais() + " " + empleado1.salarioBruto()  + " " + empleado1.obtenerEmail());

		//Extraer del empleado su trabajo y su departamento en variables de su tipo. Y pintarlas con syso.
		System.out.println("El empleado " + empleado1.nombreCompleto() + ", tiene un id de trabajo " + empleado1.getTrabajo().getIdTrabajo() + " en el departamento de " + empleado1.getDepartamento().getDescripcion() + " situado en " + empleado1.getDepartamento().getLocalidad().getCiudad());
